  ...
  return (
    <div className={css.contentComponent}>
      <div className={css.body}>
        ...
        <p className={css.text}>
          &nbsp; We may collect various types of personal data that you voluntarily provide when interacting with our website, registering
          an account or filling out forms. This may include your name, email address, phone number and more.
        </p>
        <p className={css.downMargin}> How we use your personal data:</p>{' '}
        <p className={css.text}>
          &nbsp; We use the collected personal data to provide services, manage your account, provide you with information about our
          products and services, and to communicate with you regarding inquiries and updates.
        </p>
